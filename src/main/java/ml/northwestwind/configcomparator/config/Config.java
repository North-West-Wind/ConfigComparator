...
public class Config {
    ...
    private static void init() {
        ...
        CHECK_INTERVAL = COMMON_BUILDER.comment("The interval (in milliseconds) between each file check.", "0 to disable the interval and only check once (login).").defineInRange("check_interval", 300000L, 0, Long.MAX_VALUE);
